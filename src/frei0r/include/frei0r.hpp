...
namespace frei0r
{
  ...
  static std::vector<param_info> s_param_infos;
  ...
  public:
			...
			const std::string& desc)
    {
      ...
      param_infos.push_back(param_info(name,desc,F0R_PARAM_COLOR));
    }
    ...
    {
      param_ptrs.push_back(&p_loc);
      param_infos.push_back(param_info(name,desc,F0R_PARAM_DOUBLE));
    }
    ...
    {
      param_ptrs.push_back(&p_loc);
      param_infos.push_back(param_info(name,desc,F0R_PARAM_BOOL));
    }
    ...
    {
      param_ptrs.push_back(&p_loc);
      param_infos.push_back(param_info(name,desc,F0R_PARAM_POSITION));
    }
    ...
    {
      param_ptrs.push_back(&p_loc);
      param_infos.push_back(param_info(name,desc,F0R_PARAM_STRING));
    }
    ...
    void get_param_value(f0r_param_t param, int param_index)
    {
      ...
      switch (param_infos[param_index].m_type)
	{
	case F0R_PARAM_BOOL :
...
void f0r_get_plugin_info(f0r_plugin_info_t* info)
{
  ...
  info->num_params = (int) frei0r::s_param_infos.size();
}

void f0r_get_param_info(f0r_param_info_t* info, int param_index)
{
  info->name=frei0r::s_param_infos[param_index].m_name.c_str();
  info->type=frei0r::s_param_infos[param_index].m_type;
  info->explanation=frei0r::s_param_infos[param_index].m_desc.c_str();
}
